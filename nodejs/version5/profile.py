...
class MI2:
  ...
  def point(self):
    ...
    if self.points[10] is None:
          self.points[10]=self.points[13]
    if self.points[13] is None:
          self.points[13]=self.points[10]
          
    return neck,self.points[1][0]+4,upwidth,max(self.points[8][1],self.points[11][1])+20,self.points[14][0]+4,bottomwidth,self.points[10][1]
